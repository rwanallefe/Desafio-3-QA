...
describe('Login GitHub Plataforma My Store - RWAN', () =>{

    it('Criar um login na plataforma', () =>{
        cy.visit('http://automationpractice.com/index.php/')

        cy.get('.login').click()

        cy.get('#email_create').type('concetta5722@uorak.com')
    ...
    it('Navegar pelo menu, selecionar produto e realizar compra', () =>{
        ...
        cy.get('#email').type('concetta5722@uorak.com')
        cy.get('#passwd').type('rwan1234')
    ...
    it('Verificar o status da compra no historico da compra', () =>{
